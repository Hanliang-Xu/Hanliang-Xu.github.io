        ...
        <div className="home-box">
            <div className="left-section">
                ...
                <div className="content">
                    <p>I am</p>
                    <ul>
                        <li className="medium-font">• a CS and Math major at Vanderbilt University
                        </li>
                        <li className="medium-font">• a researcher in applying machine learning to
                            medical image analysis
                        </li>
                        <li className="medium-font">• a web developer for two organizations Book'em
                            and Generation Rise
                        </li>
